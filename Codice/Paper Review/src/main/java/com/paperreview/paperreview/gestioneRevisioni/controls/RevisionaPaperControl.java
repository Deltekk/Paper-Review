...
public class RevisionaPaperControl implements ControlledScreen {
    ...
    private RevisionaPaperFormModel revisioneForm;
    ...
    public void initialize() {
        ...
        revisioneForm = new RevisionaPaperFormModel();

        Form form = revisioneForm.createForm();
    ...
    public void handleConferma() {
        try {
            ...
            String testo = revisioneForm.getRevisione();
            String puntiForza = revisioneForm.getPuntiDiForza();
            String puntiDebolezza = revisioneForm.getPuntiDiDebolezza();
            String commentoChair = revisioneForm.getCommentoChair();
